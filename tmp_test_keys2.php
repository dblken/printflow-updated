...
$key = 'xnd_development_1ae8oRxdHGUZplBgkXyVmA8qPplA7AgRWG2cv5xUpW4lUoa2ALoejNqyqBF';
echo "Testing New Key: $key\n";
...
function custom_xendit_test($key, $orderId, $amount) {
    ...
    $payload = [
        'external_id' => 'order_' . $orderId . '_' . time(), // unique external_id
        'amount' => $amount,
