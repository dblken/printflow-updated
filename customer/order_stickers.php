    ...
    <div class="container mx-auto px-4" style="max-width: 640px;">
        ...
        <div class="card">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div style="display:flex; gap:10px; margin-top:1.25rem; justify-content:flex-end; flex-wrap:wrap;">
                    ...
                    <button type="submit" name="buy_now" value="1" style="height:44px; min-width:140px; padding:0 18px; display:inline-flex; align-items:center; justify-content:center; background:#0a2530; color:#ffffff; font-weight:700; border-radius:10px; border:none; cursor:pointer; transition:all 0.2s; font-size:0.85rem; text-transform:uppercase; letter-spacing:0.02em;">
                        Buy Now
                    </button>
                </div>
            </form>
